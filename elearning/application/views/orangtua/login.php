...
orangtua dapat terus belajar dan mengajar dimana saja dan kapan saja.
-->
                ...
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <p class="text-muted">Sebelum masuk ke halaman orangtua, anda harus login terlebih dahulu sebagai
                            orangtua. silahkan isi data dibawah untuk melanjutkan.</p>
                        <form method="post" action="<?= base_url('welcome/orangtua') ?>" class="needs-validation" novalidate="">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/ss.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-white">Selamat datang, orangtua!</h1>
