    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-md-6 single-footer-widget">
                <h4>Tentang Kami</h4>
                <ul>
                    <li><a href="<?= base_url('welcome/tentang') ?>">Tentang eloku</a></li>
                    <li><a href="<?= base_url('welcome/materi') ?>">Materi eloku</a></li>
                    <li><a href="<?= base_url('welcome/kontak') ?>">Kontak eloku</a></li>
